...
# 导入各流水线模块
from core.vlm_pdf_parser import main as vlm_parser_main
from core.pipeline.loader import DocumentLoader
from core.pipeline.extraction import run_extraction
from core.pipeline.graph_builder import main as graph_builder_main
from core.pipeline.embedding import main as embedding_main
